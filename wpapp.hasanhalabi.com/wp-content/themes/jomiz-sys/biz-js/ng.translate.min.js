 ...
 */
angular.module("jomiz.translate", ["ng"]).factory("jTranslate", ["$rootScope", function ($rootScope) {
 var getDictionaryValue = window.getDictionaryValue;
 //public methods
 var self = {
  getDictionaryValue: function (dictionary, key) {
   var preferredLangKey = jQuery('html').attr('lang');

   if (dictionary[preferredLangKey] == undefined) {
    preferredLangKey = 'en_US';
   }
   return dictionary[preferredLangKey][key];
  }
 }
 return self;
}]);
