					...
					<div class="row">
						<div class="col-xs-12 text-left m-b">
							<div class="btn-group btn-group-sm" role="group">
								<button type="button" class="btn btn-white btn-outline btn-sm text-info"
								        title="Export To Excel"
								        ng-click='rootUtilities.exportTableToExcel("rptDataTable","datatable")'><i
										class="fa fa-file-excel-o"></i></button>
								<button type="button" class="btn btn-white btn-outline btn-sm text-danger"
								        title="Export To Excel" ng-click='rootUtilities.exportTableToPDF()'><i
