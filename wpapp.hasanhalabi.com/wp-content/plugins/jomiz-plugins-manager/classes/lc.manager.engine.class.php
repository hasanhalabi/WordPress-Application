...
class lc_manager_engine {

    public static function lc_manager_send_data_to_client($data, $repsonseType, $isOk = true, $forceDataAsArray = false) {
        ...
        if ($repsonseType == 'json') {
            ...
            header('Content-Disposition: attachment; filename=totso.txt');
    ...
    public static function lc_manager_validate_request($requestData) {
        $errors = array();
        ...
        if (sizeof($errors) > 0) {
            ...
            self::lc_manager_send_data_to_client((object) array(
    ...
    public static function lc_manager_process_request($requestData) {
        ...
        if (!class_exists($class_name)) {
            ...
            self::lc_manager_send_data_to_client($error, $repsonseType, FALSE);
            return;
        }
        ...
        try {
            ...
            self::lc_manager_send_data_to_client($data, $repsonseType);
        } catch (Exception $e) {
            $error = (object) array(
